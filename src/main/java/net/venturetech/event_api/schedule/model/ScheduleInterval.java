...
package net.venturetech.event_api.schedule.model;
...
import static net.venturetech.event_api.schedule.model.ScheduleIntervalLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.schedule.model.ScheduleInterval",
    i18n = {
