...
package net.venturetech.event_api.guide;
...
import static net.venturetech.event_api.guide.HTMLGuideLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.guide.HTMLGuide",
    i18n = {
