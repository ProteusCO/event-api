...
import net.venturetech.event_api.support.address.Utils.NamedGroupPattern;

import static net.venturetech.event_api.support.address.RegexLibrary.*;
import static net.venturetech.event_api.support.address.Utils.compile;
