...
import static net.venturetech.event_api.support.ui.contact.PhoneNumberValueEditorLOK.*;
...
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.support.ui.contact.PhoneNumberValueEditor",
    i18n = {
