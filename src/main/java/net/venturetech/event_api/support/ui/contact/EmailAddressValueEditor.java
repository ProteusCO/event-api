...
import static net.venturetech.event_api.support.ui.contact.EmailAddressValueEditorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.support.ui.contact.EmailAddressValueEditor",
    i18n = {
