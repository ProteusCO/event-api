...
import static net.venturetech.event_api.support.ui.contact.NameValueEditorLOK.*;
...
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.support.ui.contact.NameValueEditor",
    i18n = {
