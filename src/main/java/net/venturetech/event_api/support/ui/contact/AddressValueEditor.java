...
import static net.venturetech.event_api.support.ui.contact.AddressValueEditorLOK.*;
...
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.support.ui.contact.AddressValueEditor",
    i18n = {
