...
package net.venturetech.event_api.config;
...
@ComponentScan({"net.venturetech.event_api"}/*Scan for spring components in my package hierarchy*/)
...
@PropertySource(
    name = "your-app-props",
    value = {
        "classpath:/net/venturetech/event_api/config/default.properties",
...
public class ProjectConfig implements ApplicationListener<ContextRefreshedEvent>
{
    ...
    {
        return "net.venturetech.event_api.note";
    }
    ...
    {
        return "net.venturetech.event_api.profile";
    }
    ...
    /**
     * Scan net.venturetech for HBM XML files.
     *
     * @return bean.
     */
    @Bean()
    ...
    {
        return "classpath*:net/venturetech/event_api/model/schedule/**/*.hbm.xml";
    }
    ...
    {
        return "classpath*:net/venturetech/event_api/login/social/ui/**/*.hbm.xml";
    }
    ...
    public StaticKeyDataConfig staticKeyDataConfig()
    {
        ...
        config.addScanPackage("net.venturetech.event_api");
