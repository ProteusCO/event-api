...
import static net.venturetech.event_api.profile.service.DefaultProfileTermProviderLOK.*;
...
@Qualifier("default")
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.service.DefaultProfileTermProvider",
    i18n = {
