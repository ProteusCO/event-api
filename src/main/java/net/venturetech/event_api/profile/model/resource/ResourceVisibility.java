...
package net.venturetech.event_api.profile.model.resource;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.model.resource.ResourceVisibility",
    i18n = {
...
{
    /** Public Visibility */
    Public(ResourceVisibilityLOK.NAME_PUBLIC()),
    /** Private Visibility */
    Private(ResourceVisibilityLOK.NAME_PRIVATE());
