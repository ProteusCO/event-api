...
import static net.venturetech.event_api.profile.model.repository.RepositoryItemStatusLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.model.repository.RepositoryItemStatus",
    i18n = {
