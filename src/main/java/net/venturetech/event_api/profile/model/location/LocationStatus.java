...
import static net.venturetech.event_api.profile.model.location.LocationStatusLOK.*;
...
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.model.location.LocationStatus",
    i18n = {
