...
package net.venturetech.event_api.profile.model.terminology;
...
import static net.venturetech.event_api.config.ProjectCacheRegions.PROFILE_DATA;
import static net.venturetech.event_api.config.ProjectConfig.PROJECT_SCHEMA;
