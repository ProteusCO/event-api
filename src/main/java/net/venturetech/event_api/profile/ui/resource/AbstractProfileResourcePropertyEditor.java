...
import net.venturetech.event_api.profile.model.resource.ResourceDAO;
...
import net.venturetech.event_api.profile.ui.repository.ResourceRepositoryItemValueEditor;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.resource.AbstractProfileResourcePropertyEditor",
    i18n = {
