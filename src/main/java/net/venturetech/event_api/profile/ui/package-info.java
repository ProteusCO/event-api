...
@I18NFiles(@I18NFile(
    ...
    symbolPrefix = "net.venturetech.event_api.profile.ui.UIText",
    i18n = {
        ...
        @I18N(symbol = "Instructions Picture Editor FMT",
            l10n = @L10N("Image is optional.  Optimal size for image is {0} x {1}.")),
        ...
        @I18N(symbol = "Membership",
            description = "",
            l10n = @L10N("Role")),
        @I18N(symbol = "Memberships",
            description = "",
            l10n = @L10N("Roles")),
        @I18N(symbol = "Membership Type",
            description = "",
            l10n = @L10N("Role Type")),
        @I18N(symbol = "User",
            description = "",
        ...
        @I18N(symbol = "Profile",
            description = "",
            l10n = @L10N("Profile")),
        @I18N(symbol = "Profile Type",
            description = "",
            l10n = @L10N("Profile Type")),
        @I18N(symbol = "Resource",
            description = "",
            l10n = @L10N("Resource")),
        @I18N(symbol = "Repository",
            description = "",
            l10n = @L10N("Repository")),
        @I18N(symbol = "Users",
            description = "",
            l10n = @L10N("Users")),
        @I18N(symbol = "Resources",
            description = "",
            l10n = @L10N("Resources"))
    }
))
