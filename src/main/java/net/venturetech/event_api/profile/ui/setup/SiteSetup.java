...
package net.venturetech.event_api.profile.ui.setup;

import net.venturetech.event_api.profile.model.company.Company;
import net.venturetech.event_api.profile.model.company.CompanyStatus;
import net.venturetech.event_api.profile.model.setup.SiteSetupDAO;
...
import net.venturetech.event_api.profile.ui.company.AbstractCompanyPropertyEditor;
...
import static net.venturetech.event_api.profile.ui.setup.SiteSetupLOK.COMPONENT_NAME;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.setup.SiteSetup",
    i18n = {
