...
import net.venturetech.event_api.support.ui.CustomCKEditorConfig;
...
import static net.venturetech.event_api.profile.ui.user.MessageContextValueEditorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.MessageContextValueEditor",
    i18n = {
