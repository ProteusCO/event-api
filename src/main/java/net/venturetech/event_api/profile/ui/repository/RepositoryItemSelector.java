...
package net.venturetech.event_api.profile.ui.repository;

import net.venturetech.event_api.profile.model.membership.MembershipOperation;
...
import net.venturetech.event_api.profile.model.repository.RepositoryItem;
import net.venturetech.event_api.profile.model.terminology.ProfileTermProvider;
...
import net.venturetech.event_api.support.ui.search.SelectActionColumn;
...
import static net.venturetech.event_api.profile.ui.UIText.*;
import static net.venturetech.event_api.profile.ui.repository.RepositoryItemSelector.RepositoryItemSelectorMode.LONG;
import static net.venturetech.event_api.profile.ui.repository.RepositoryItemSelector.RepositoryItemSelectorMode.SHORT;
...
public abstract class RepositoryItemSelector<RI extends RepositoryItem> extends Container implements SearchUIOperationHandler
{
    ...
    @Autowired
    protected MembershipOperationConfiguration _mop;
    ...
    /**
     * Is force select first boolean.
     *
     * @return the boolean
     */
    public boolean isForceSelectFirst()
    {
        return _forceSelectFirst;
    }

    /**
     * Sets force select first.
     *
     * @param forceSelectFirst the force select first
     */
    public void setForceSelectFirst(boolean forceSelectFirst)
    {
        _forceSelectFirst = forceSelectFirst;
    }

    /**
     * Gets force select first and reset.
     *
     * @return the force select first and reset
     */
    public boolean getForceSelectFirstAndReset()
    {
        boolean result = _forceSelectFirst;
        _forceSelectFirst = false;
        return result;
    }
