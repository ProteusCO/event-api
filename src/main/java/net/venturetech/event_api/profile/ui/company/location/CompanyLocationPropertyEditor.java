...
import net.venturetech.event_api.profile.ui.location.AbstractLocationPropertyEditor;
...
import static net.venturetech.event_api.profile.ui.company.location.CompanyLocationPropertyEditorLOK.COMPONENT_NAME;
import static net.venturetech.event_api.support.service.Functions.opt;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.company.location.CompanyLocationPropertyEditor",
    i18n = {
