...
import static net.venturetech.event_api.profile.ui.company.AbstractCompanyPropertyEditorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.company.AbstractCompanyPropertyEditor",
    i18n = {
