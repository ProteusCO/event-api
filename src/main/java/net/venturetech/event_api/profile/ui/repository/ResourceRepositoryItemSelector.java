...
import static net.venturetech.event_api.profile.ui.repository.ResourceRepositoryItemSelectorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.repository.ResourceRepositoryItemSelector",
    i18n = {
