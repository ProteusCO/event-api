...
import static net.venturetech.event_api.profile.ui.user.MyAccountViewLOK.COMPONENT_NAME;
import static net.venturetech.event_api.profile.ui.user.MyAccountViewLOK.LABEL_UPDATE_PASSWORD;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.MyAccountView",
    i18n = {
