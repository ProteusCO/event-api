...
package net.venturetech.event_api.profile.ui.company.location;
...
import net.venturetech.event_api.profile.model.location.LocationDAO;
...
import net.venturetech.event_api.profile.ui.location.AbstractLocationManagement;
import net.venturetech.event_api.support.ui.Application;
import net.venturetech.event_api.support.ui.search.SearchUIHelper;
import net.venturetech.event_api.support.ui.search.ToggleDeleteNavigationColumn;
...
import static net.venturetech.event_api.profile.model.location.LocationStatus.ACTIVE;
import static net.venturetech.event_api.profile.model.location.LocationStatus.INACTIVE;
import static net.venturetech.event_api.profile.ui.company.location.CompanyLocationManagementLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.company.location.CompanyLocationManagement",
    i18n = {
