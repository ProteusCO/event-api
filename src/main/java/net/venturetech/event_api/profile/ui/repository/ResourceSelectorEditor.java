...
import net.venturetech.event_api.support.service.ArrayCollector;
 ...
 */
@I18NFile(symbolPrefix = "net.venturetech.event_api.profile.ui.repository.ResourceSelectorEditor",
            ...
            addValidator((component, notifiable) -> {
                ...
                if (uiVal == null || uiVal.isEmpty())
                {
                    NotificationImpl error = new NotificationImpl(NotificationType.ERROR,
                        ResourceSelectorEditorLOK.ERROR_MESSAGE_AT_LEAST_ONE_RESOURCE_REQUIRED_FMT(RESOURCES()));
