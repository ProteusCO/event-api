...
import net.venturetech.event_api.support.ui.contact.ContactValueEditor;
import net.venturetech.event_api.support.ui.contact.ContactValueEditor.ContactValueEditorConfig;
...
import static net.venturetech.event_api.profile.ui.user.PrincipalValueEditorLOK.*;
import static net.venturetech.event_api.support.ui.contact.AddressValueEditor.AddressValueEditorConfig;
import static net.venturetech.event_api.support.ui.contact.ContactValueEditor.ContactField;
import static net.venturetech.event_api.support.ui.contact.EmailAddressValueEditor.EmailAddressValueEditorConfig;
import static net.venturetech.event_api.support.ui.contact.NameValueEditor.NameField.first;
import static net.venturetech.event_api.support.ui.contact.NameValueEditor.NameField.last;
import static net.venturetech.event_api.support.ui.contact.NameValueEditor.NameValueEditorConfig;
import static net.venturetech.event_api.support.ui.contact.PhoneNumberValueEditor.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.PrincipalValueEditor",
    i18n = {
