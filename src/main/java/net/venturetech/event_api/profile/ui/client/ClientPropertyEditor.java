...
import static net.venturetech.event_api.profile.ui.client.ClientPropertyEditorLOK.COMPONENT_NAME;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.client.ClientPropertyEditor",
    i18n = {
