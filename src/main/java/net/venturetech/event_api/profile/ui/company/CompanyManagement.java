...
import net.venturetech.event_api.support.ui.search.SearchUIHelper;
...
import static net.venturetech.event_api.profile.model.company.CompanyStatus.Active;
import static net.venturetech.event_api.profile.model.company.CompanyStatus.Inactive;
import static net.venturetech.event_api.profile.ui.UIText.*;
import static net.venturetech.event_api.profile.ui.company.CompanyManagementLOK.*;
import static net.venturetech.event_api.profile.ui.company.CompanyValueEditorLOK.LABEL_WEBSITE;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.company.CompanyManagement",
    i18n = {
...
//                case view: Handled by NavigationLinkColumn
    ...
    private void addColumns(SearchModelImpl searchModel)
    {
        ...
        searchModel.getResultColumns().add(new SearchResultColumnImpl()
            ...
            .withTableCellRenderer(renderUsing(EMPTY, (Company company) -> Optional.ofNullable(company)
