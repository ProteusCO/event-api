...
import static net.venturetech.event_api.profile.ui.user.UserPositionManagementLOK.*;
import static net.venturetech.event_api.support.service.AppUtil.UTC;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.UserPositionManagement",
    i18n = {
