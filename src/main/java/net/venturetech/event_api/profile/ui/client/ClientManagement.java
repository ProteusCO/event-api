...
import net.venturetech.event_api.profile.model.client.ClientDAO;
import net.venturetech.event_api.profile.model.client.ClientLOK;
...
import static net.venturetech.event_api.profile.ui.client.ClientManagementLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.client.ClientManagement",
    i18n = {
