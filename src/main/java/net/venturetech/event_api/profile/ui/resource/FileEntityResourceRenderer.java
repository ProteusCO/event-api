 ...
 */
@I18NFile(symbolPrefix = "net.venturetech.event_api.profile.ui.resource.FileEntityResourceRenderer",
    i18n = @I18N(symbol = "Label Download", l10n = @L10N("Download")))
    ...
    public void render(CmsRequest<PageElement> request, CmsResponse response, RenderChain chain) throws IOException
    {
        ...
        if (fe != null)
        {
            ...
            pw.append("<a")
                ...
                .append(">")
                .append(FileEntityResourceRendererLOK.LABEL_DOWNLOAD().getText(lc))
                .append("</a>");
            pw.print("</span>");
