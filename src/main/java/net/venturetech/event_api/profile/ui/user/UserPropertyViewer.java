...
import static net.venturetech.event_api.profile.ui.user.UserPropertyViewerLOK.ERROR_MESSAGE_INSUFFICIENT_PERMISSIONS_VIEW_FMT;
import static net.venturetech.event_api.profile.ui.user.UserPropertyViewerLOK.LABEL_UPDATE_PASSWORD;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.UserPropertyViewer",
    i18n = {
