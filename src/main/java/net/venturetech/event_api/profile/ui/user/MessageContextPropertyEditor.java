...
import net.venturetech.event_api.communication.service.NotificationService;
...
import static net.venturetech.event_api.profile.ui.user.MessageContextPropertyEditorLOK.BUTTON_TEXT_SEND;
import static net.venturetech.event_api.profile.ui.user.MessageContextPropertyEditorLOK.ERROR_PONESMS;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.MessageContextPropertyEditor",
    i18n = {
