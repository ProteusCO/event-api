...
import static net.venturetech.event_api.profile.ui.UIText.INFO;
import static net.venturetech.event_api.profile.ui.UIText.MEMBERSHIPS;
import static net.venturetech.event_api.profile.ui.client.ClientViewerComponentLOK.COMPONENT_NAME;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.client.ClientViewerComponent",
    i18n = {
