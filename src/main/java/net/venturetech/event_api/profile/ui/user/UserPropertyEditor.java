...
import static net.venturetech.event_api.profile.ui.user.UserPropertyEditorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.UserPropertyEditor",
    i18n = {
