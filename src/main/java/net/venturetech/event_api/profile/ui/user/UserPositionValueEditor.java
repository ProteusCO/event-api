...
import static net.venturetech.event_api.profile.ui.user.UserPositionValueEditorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.UserPositionValueEditor",
    i18n = {
