...
package net.venturetech.event_api.profile.ui;
...
public final class ApplicationFunctions
{
    ...
    /**
     * Static class defining Application Functions for {@link net.venturetech.event_api.profile.model.company.Company}
     *
     * @author Alan Holt (aholt@venturetech.net)
     */
    public static final class Company
    {
        ...
        /**
         * Static class defining Application Functions for {@link net.venturetech.event_api.profile.model.resource.Resource}s on a
         * Company
         *
         * @author Alan Holt (aholt@venturetech.net)
         */
        ...
        /**
         * Static class defining Application Functions for {@link net.venturetech.event_api.profile.model.location.Location}s on a
         * Company
         *
         * @author Alan Holt (aholt@venturetech.net)
         */
    ...
    /**
     * Static class defining Application Functions for {@link net.venturetech.event_api.profile.model.client.Client}.
     *
     * @author Alan Holt (aholt@venturetech.net)
     */
