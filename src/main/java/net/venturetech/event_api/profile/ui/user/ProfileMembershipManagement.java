...
import net.venturetech.event_api.profile.model.ProfileType;
...
import net.venturetech.event_api.profile.model.membership.MembershipTypeProvider;
...
import static net.venturetech.event_api.profile.ui.user.ProfileMembershipManagementLOK.*;
import static net.venturetech.event_api.profile.ui.user.UserMembershipManagementLOK.BUTTON_TEXT_MODIFY;
import static net.venturetech.event_api.profile.ui.user.UserMembershipManagementLOK.DELETE_CONFIRM_TEXT_FMT;
import static net.venturetech.event_api.support.service.AppUtil.*;
...
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.ProfileRoleManagement",
    i18n = {
