...
import static net.venturetech.event_api.profile.ui.user.UserMembershipManagementLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.UserMembershipManagement",
    i18n = {
