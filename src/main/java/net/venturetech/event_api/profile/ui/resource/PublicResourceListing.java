...
import static net.venturetech.event_api.profile.ui.resource.PublicResourceListingLOK.COMPONENT_NAME;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.resource.PublicResourceListing",
    i18n = {
...
public class PublicResourceListing extends AbstractProfileResourceListing
{
    @Autowired
