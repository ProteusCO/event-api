...
import static net.venturetech.event_api.profile.ui.user.UserViewerComponentLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.UserViewerComponent",
    i18n = {
