...
import net.venturetech.event_api.profile.model.resource.FileEntityResource;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.resource.FileEntityResourceType",
    i18n = {
...
public class FileEntityResourceType implements ResourceType
{
    ...
    {
        return FileEntityResourceTypeLOK.NAME();
    }
    ...
    {
        return FileEntityResourceTypeLOK.DESCRIPTION();
    }
