...
import net.venturetech.event_api.profile.model.repository.RepositoryDAO;
import net.venturetech.event_api.profile.model.repository.RepositoryItemRelation;
import net.venturetech.event_api.profile.model.repository.RepositoryItemRelationType;
import net.venturetech.event_api.profile.model.repository.RepositoryItemStatus;
import net.venturetech.event_api.profile.model.repository.ResourceRepositoryItem;
import net.venturetech.event_api.profile.model.resource.Resource;
...
import net.venturetech.event_api.profile.service.resource.ResourceCategoryLabelProvider;
import net.venturetech.event_api.profile.service.resource.ResourceTagsLabelProvider;
import net.venturetech.event_api.profile.service.resource.ResourceTypeService;
import net.venturetech.event_api.profile.ui.ApplicationFunctions;
import net.venturetech.event_api.profile.ui.UIText;
...
import static net.venturetech.event_api.profile.ui.UIText.REPOSITORY;
import static net.venturetech.event_api.profile.ui.UIText.RESOURCE;
import static net.venturetech.event_api.profile.ui.company.resource.CompanyResourceManagementLOK.*;
import static net.venturetech.event_api.support.service.AppUtil.nullFirst;

/**
 * UI for managing {@link ResourceRepositoryItem}s for a {@link Company}
 *
 * @author Alan Holt (aholt@venturetech.net)
 * @since 12/11/15 4:19 PM
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.company.resource.CompanyResourceManagement",
    i18n = {
        @I18N(symbol = "Component Name", l10n = @L10N("Company Resource Management")),
...
public class CompanyResourceManagement extends MIWTPageElementModelContainer implements SearchUIOperationHandler
{
     ...
     */
    public CompanyResourceManagement()
    {
        super();
    ...
    private void addResultColumns(SearchModelImpl searchModel)
    {
        ...
        actions.getViewLink().configure()
            .toPage(ApplicationFunctions.Company.Resource.VIEW);
        ...
        searchModel.getResultColumns().add(nameColumn = new SearchResultColumnImpl()
            ...
            .withTableColumn(new PropertyColumn(ResourceRepositoryItem.class,
                ResourceRepositoryItem.RESOURCE_PROP + '.' + Resource.NAME_COLUMN_PROP).withColumnName(
                LABEL_NAME()))
        ...
        searchModel.getResultColumns().add(new SearchResultColumnImpl()
            .withName("author")
            .withTableColumn(new PropertyColumn(ResourceRepositoryItem.class,
                ResourceRepositoryItem.RESOURCE_PROP + '.' + Resource.AUTHOR_COLUMN_PROP).withColumnName(
                LABEL_AUTHOR()))
