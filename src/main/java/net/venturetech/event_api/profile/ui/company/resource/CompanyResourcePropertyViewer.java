...
import net.venturetech.event_api.profile.ui.resource.AbstractProfileResourcePropertyViewer;
...
import static net.venturetech.event_api.profile.ui.company.resource.CompanyResourcePropertyViewerLOK.COMPONENT_NAME;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.company.resource.CompanyResourcePropertyViewer",
    i18n = {
