...
import static net.venturetech.event_api.profile.ui.repository.ResourceSelectorLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.repository.ResourceSelector",
    i18n = {
