...
import net.venturetech.event_api.profile.model.resource.URIResource;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.resource.URIResourceType",
    i18n = {
...
public class URIResourceType implements ResourceType
{
    ...
    {
        return URIResourceTypeLOK.NAME();
    }
    ...
    {
        return URIResourceTypeLOK.DESCRIPTION();
    }
