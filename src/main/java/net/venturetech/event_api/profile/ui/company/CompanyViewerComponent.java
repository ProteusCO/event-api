...
package net.venturetech.event_api.profile.ui.company;

import net.venturetech.event_api.profile.model.company.Company;
import net.venturetech.event_api.profile.model.company.CompanyDAO;
import net.venturetech.event_api.profile.model.membership.MembershipTypeInfo;
import net.venturetech.event_api.profile.model.terminology.ProfileTerms;
import net.venturetech.event_api.profile.service.SelectedCompanyTermProvider;
...
import net.venturetech.event_api.profile.ui.membership.ProfileTypeMembershipTypeManagement;
import net.venturetech.event_api.profile.ui.terminology.ProfileTermsEditor;
import net.venturetech.event_api.profile.ui.terminology.ProfileTermsViewer;
import net.venturetech.event_api.support.ui.Application;
import net.venturetech.event_api.support.ui.UIPreferences;
import net.venturetech.event_api.support.ui.text.LabelDomainLabelManagement;
...
import static net.venturetech.event_api.profile.ui.URLProperties.COMPANY;
import static net.venturetech.event_api.profile.ui.URLProperties.COMPANY_PATH_INFO;
import static net.venturetech.event_api.profile.ui.company.CompanyViewerComponentLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.company.CompanyViewerComponent",
    i18n = {
