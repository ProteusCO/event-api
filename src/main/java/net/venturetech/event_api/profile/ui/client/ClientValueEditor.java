...
import net.venturetech.event_api.profile.model.client.Client;
import net.venturetech.event_api.profile.model.client.ClientStatus;
import net.venturetech.event_api.profile.model.location.Location;
import net.venturetech.event_api.support.service.AppUtil;
import net.venturetech.event_api.support.ui.CommonEditorFields;
import net.venturetech.event_api.support.ui.contact.AddressValueEditor;
import net.venturetech.event_api.support.ui.contact.AddressValueEditor.AddressValueEditorConfig;
import net.venturetech.event_api.support.ui.contact.EmailAddressValueEditor;
import net.venturetech.event_api.support.ui.contact.EmailAddressValueEditor.EmailAddressValueEditorConfig;
import net.venturetech.event_api.support.ui.contact.PhoneNumberValueEditor;
import net.venturetech.event_api.support.ui.contact.PhoneNumberValueEditor.PhoneNumberValueEditorConfig;
import net.venturetech.event_api.support.ui.vtcrop.VTCropPictureEditor;
import net.venturetech.event_api.support.ui.vtcrop.VTCropPictureEditorConfig;
...
import static net.venturetech.event_api.profile.ui.UIText.INSTRUCTIONS_PICTURE_EDITOR_FMT;
import static net.venturetech.event_api.profile.ui.client.ClientValueEditorLOK.LABEL_LOGO;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.client.ClientValueEditor",
    i18n = {
