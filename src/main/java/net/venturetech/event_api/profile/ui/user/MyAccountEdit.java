...
import static net.venturetech.event_api.profile.ui.user.MyAccountEditLOK.COMPONENT_NAME;
import static net.venturetech.event_api.profile.ui.user.MyAccountEditLOK.ERROR_MESSAGE_USERNAME_EXISTS_FMT;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.MyAccountEdit",
    i18n = {
