...
import net.venturetech.event_api.profile.model.user.UserPosition;
...
import static net.venturetech.event_api.profile.ui.user.UserManagementLOK.*;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.UserManagement",
    i18n = {
