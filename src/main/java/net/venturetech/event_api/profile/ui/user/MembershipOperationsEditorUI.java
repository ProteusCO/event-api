...
import static net.venturetech.event_api.profile.ui.UIText.USER;
import static net.venturetech.event_api.profile.ui.membership.MembershipTypeOperationsEditorUILOK.*;
import static net.venturetech.event_api.profile.ui.user.MembershipOperationsEditorUILOK.MEMBERSHIP_UI_HEADING_FORMAT;
 ...
 */
@I18NFile(
    symbolPrefix = "net.venturetech.event_api.profile.ui.user.MembershipOperationsEditorUI",
    i18n = {
...
class MembershipOperationsEditorUI extends Container
{
    ...
    public void init()
    {
        ...
        Label heading = new Label(createText(MEMBERSHIP_UI_HEADING_FORMAT(),
