...
package net.venturetech.event_api.config.automation
 ...
 */
@Profile(["automation", "net.venturetech.event_api.demo.1"])
@Configuration
@Lazy
...
class ProjectDataConversion1
{
    ...
    private static final String IDENTIFIER = 'event-api'
