...
package net.venturetech.event_api.config.automation.profile
...
/**
 * Data conversions for Profile API
...
@Configuration
@Lazy
class ProfileDataConversionVersion1
{
    private static final String IDENTIFIER = "event-api-profile"
